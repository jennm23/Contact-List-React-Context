                            ...
                            <div className="card">
                                <div className="row no-gutters">
                                    <div className="col-md-4">
                                        <img className="card-img" src={userImg} alt={contact.name} />
                                    </div>
                                    <div className="col-md-8">
                                        <div className="card-body">
                                            ...
                                            <div className="">
                                                <Link to={`/EditContact/${contact.id}`} className="btn" style={{ marginRight: '0.5rem' }}>
                                                    <i className="fa fa-edit"></i>
                                                </Link>
                                                <button className="btn" onClick={() => handleDeleteContact(contact.id)}>
